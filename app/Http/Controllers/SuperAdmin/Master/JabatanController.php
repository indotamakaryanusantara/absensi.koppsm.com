...
class JabatanController extends Controller
{
    ...
    public function index()
    {
        ...
        $user = Auth::user();
        return view('pages.superadmin.master.jabatan.dashboard', [
            'jabatan' => $jabatan,
            'user' => $user
        ]);
    }
    ...
    {
        return view('pages.superadmin.master.jabatan.tambah');
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('superadmin-jabatan.index');
    }
    ...
    public function edit(string $id)
    {
        ...
        return view('pages.superadmin.master.jabatan.edit', [
            'item' => $item,
        ]);
    }
