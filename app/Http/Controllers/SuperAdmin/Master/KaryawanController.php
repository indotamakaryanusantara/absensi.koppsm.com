...
class KaryawanController extends Controller
{
    public function index()
    {
        ...
        return view('pages.superadmin.master.karyawan.dashboard', [
            'user' => $user,
        ]);
    }
    ...
    public function create()
    {
        ...
        return view('pages.superadmin.master.karyawan.tambah', [
            'cabang' => $cabang,
            'jabatan' => $jabatan,
            'divisi' => $divisi,
        ]);
    ...
    public function edit(string $id)
    {
        ...
        $jabatan = Jabatan::where('active', 1)->get();
        $divisi = Divisi::where('active', 1)->get();
        return view('pages.superadmin.master.karyawan.edit', [
            'item' => $item,
            'cabang' => $cabang,
            'jabatan' => $jabatan,
            'divisi' => $divisi,
