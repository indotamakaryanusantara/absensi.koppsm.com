         ...
         <li class="dropdown"><a href="#" data-toggle="dropdown"
             ...
             <div class="dropdown-menu dropdown-menu-right">
                 @if (Auth::user()->id_roles == 1)
                     <a href="{{ route('superadmin.karyawan-edit', Auth::user()->id) }}" class="dropdown-item has-icon">
                         <i class="far fa-user"></i> Profile
                     </a>
                 @elseif (Auth::user()->id_roles == 2)
                     <a href="{{ route('admin.karyawan-edit', Auth::user()->id) }}" class="dropdown-item has-icon">
                         <i class="far fa-user"></i> Profile
                     </a>
                 @endif
                 @if (Auth::user()->id_roles == 1)
                     <a href="{{ route('superadmin-user.edit', Auth::user()->id) }}" class="dropdown-item has-icon">
